...
images:
  ubuntu1604:
    ...
    remote_url: http://images:8080/xenial-server-cloudimg-amd64-disk1.img
  ...
  ubuntu1804:
    ...
    needs_conversion: true
    remote_url: http://images:8080/bionic-server-cloudimg-amd64.img
  ...
  debian9:
    ...
    remote_url: http://images:8080/debian-9-openstack-amd64.raw
  ...
  debian8:
    name: debian8.raw
    needs_conversion: false
    remote_url: http://images:8080/debian-8-openstack-amd64.raw
